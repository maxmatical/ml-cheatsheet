...
Hyperband example: full_twitter_sentiment_transformers.ipynb or [hyperband_test.ipynb](https://github.com/maxmatical/fast.ai/blob/master/hyperband_test.ipynb)
